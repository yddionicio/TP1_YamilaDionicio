...
namespace FrmProducto
{
    ...
    {
        Random rdm;
        PlataformaVentas<Producto> plataformaVenta;
        ...
        public frmProducto()
        {
            InitializeComponent();
            rdm = new Random();
            plataformaVenta = new PlataformaVentas<Producto>();
        ...
        private void frmProducto_Load(object sender, EventArgs e)
        {
            ...
            bindingSource.DataSource = plataformaVenta.CargarDatos();
            dgvProducto.DataSource = bindingSource;

            dgvProducto.Update();
            dgvProducto.Refresh();
            frmVentas ventas = new frmVentas(plataformaVenta.CargarDatos());
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            plataformaVenta.Productos.Add(p);

            bindingSource.DataSource = plataformaVenta.Productos;
            dgvProducto.DataSource = bindingSource;
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (dgvProducto.SelectedRows.Count > 0)
            {
                ...
                plataformaVenta.Productos.Remove(producto);
        ...
        private void dgvProducto_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == dgvProducto.Columns["Eliminar"].Index && e.RowIndex >= 0)
            {
                ...
                plataformaVenta.Productos.Remove(p);
